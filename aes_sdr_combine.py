...
parser.add_argument("--AES_METHOD", type=str, default="AES_BOW_P")
parser.add_argument("--SDR_METHOD", type=str, default="SDR_BOW_FULL_LEE")
parser.add_argument("--COM_METHOD", type=str, default="SDR_BOW_FULL_LEE_AES_P")
