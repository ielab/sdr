...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_ncbo_collection", type=str, default="collection/boc_ncbo/ncbo_original.jsonl")
    parser.add_argument("--output_collection", type=str, default="collection/boc_ncbo/ncbo_processed_original.jsonl")
